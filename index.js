...
require('./exception-authentication-failure.js');
require('./exception-blocked-by-config.js');
require('./exception-blocked-ip.js');
require('./exception-blocked-user.js');
require('./exception-captcha-break-failed.js');
require('./exception-email-unchecked.js');
require('./exception-expected-data-not-found.js');
require('./exception-internal-email-unchecked.js');
require('./exception-internal-not-ready.js');
require('./exception-internal-push-label.js');
require('./exception-internal-server-error.js');
require('./exception-internal-user-blocked.js');
require('./exception-invalid-argument.js');
require('./exception-justice-secret.js');
require('./exception-legal-review.js');
require('./exception-missing-argument.js');
require('./exception-multiple-results-found.js');
require('./exception-not-found.js');
require('./exception-outdated.js');
require('./exception-password-required.js');
require('./exception-query-limit.js');
require('./exception-remote-site-under-maintenance.js');
require('./exception-resource-unavailable.js');
require('./exception-site-message.js');
require('./exception-table-not-found.js');
require('./exception-under-maintenance.js');
require('./exception-unexpected-http-code.js');
var exceptionUnknown = require('./exception-unknown.js');
require('./exception-without-proceedings.js');
...
var defaultApiKey = '6057b71263c21e4ada266c9d4d4da613';
...
function () {
   ...
   */
  function WebService() {
    var apiKey = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultApiKey;
    var userLimit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 5;
    var configs = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

    __chunk_1._classCallCheck(this, WebService);

    var limit = userLimit !== null ? userLimit > 10 ? 10 : userLimit : 10;
    this.bipbopLimit = promiseLimit(limit);
    this.apiKey = apiKey;
    this.configs = configs;
  }

  __chunk_1._createClass(WebService, [{
    key: "object",
    value: function object(query, form, urlData) {
      var prepareFormData = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : WebService.formData;
      return ["https://irql.bipbop.com.br/?".concat(querystring.stringify(__chunk_1._objectSpread({
        apiKey: this.apiKey,
        q: query
      }, urlData))), __chunk_1._objectSpread({}, this.configs, {
    ...
    key: "validate",
    value: function () {
      var _validate = __chunk_1._asyncToGenerator(
      /*#__PURE__*/
    ...
    key: "throwException",
    value: function throwException(xml) {
      var domParser = new domParser_3();
      var dom = domParser.parseFromString(xml);
      var tagExceptions = dom.getElementsByTagName('exception');
      if (!tagExceptions.length) return false;
      var exceptions$1 = Array.from(tagExceptions).filter(function (node) {
      ...
      if (!exceptions$1.length) return false;
      var exception = exceptions$1.pop();
      if (!exception) return false;
      var code = exception.getAttribute('code');
      var exceptionCode = code ? parseInt(code, 10) : errorCodes.E_UNKNOWN;
      var ExceptionClass = exceptionCode in exceptions ? exceptions[exceptionCode] : exceptionUnknown;
      throw ExceptionClass.factory(exception.textContent === null ? undefined : exception.textContent, exceptionCode, exception.getAttribute('push') === 'true');
    }
    /**
    ...
    value: function request(query) {
      ...
      var urlData = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      return this.bipbopLimit(function () {
        return _this.validate(fetch.apply(void 0, __chunk_1._toConsumableArray(_this.object(query, form, urlData))));
      });
    }
    /**
    ...
    value: function formData(f) {
      ...
      Object.keys(f).forEach(function (key) {
        return formData.append(key, f[key]);
      });
      return formData;
    }
  }, {
    key: "parse",
    value: function () {
      var _parse = __chunk_1._asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2(responsePromise) {
        var response, contentType, type, xml;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                type = (contentType.split(';', 2).shift() || '').split('/').pop() || '';
                _context2.next = 7;
                return response.text();
              ...
              case 7:
                xml = _context2.sent;
                _context2.t0 = type;
                _context2.next = _context2.t0 === 'json' ? 11 : _context2.t0 === 'xml' ? 12 : 13;
                break;

              case 11:
                return _context2.abrupt("return", JSON.parse(xml));

              case 12:
                return _context2.abrupt("return", new domParser_3().parseFromString(xml));
