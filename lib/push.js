...
export default class Push {
  ...
  deletedDocument(...args) {
    return this.selectDeletedDocument(...args);
  }

  deletedJob(...args) {
    return this.selectDeletedJob(...args);
  }

  document(...args) {
    return this.selectDocument(...args);
  }

  forceCallback(...args) {
    return this.selectForceCallback(...args);
  }

  fullReport(...args) {
    return this.selectFullReport(...args);
  }

  history(...args) {
    return this.selectHistory(...args);
  }

  job(...args) {
    return this.selectJob(...args);
  }

  report(...args) {
    return this.selectReport(...args);
  }

  reportRemoved(...args) {
    return this.selectReportRemoved(...args);
  }
}
